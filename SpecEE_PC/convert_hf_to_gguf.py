...
class Model:
    ...
    def map_tensor_name(self, name: str, try_suffixes: Sequence[str] = (".weight", ".bias")) -> str:
        ...
        #     print(self.tensor_map.mapping)
        #     print(self.tensor_map.mapping.get('embed_tokens'))
...
# SpecEE Model
@Model.register("EAutoForCausalLM", "EAutoForCausalLM", "MistralForCausalLM", "MixtralForCausalLM")
class EAutoModel(Model):
    model_arch = gguf.MODEL_ARCH.EAUTO
