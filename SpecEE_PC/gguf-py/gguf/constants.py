...
class MODEL_TENSOR(IntEnum):
    ...
    # AutoEE
    PRED_UP              = auto() # pred linear 1 autoee
    PRED_DOWN            = auto() # pred linear 2
    # EAGLE
    EAGLE_TOKEN_EMBD     = auto()
    EAGLE_ATTN_Q         = auto()   
    EAGLE_ATTN_K         = auto()   
    EAGLE_ATTN_V         = auto()    
    EAGLE_ATTN_OUT       = auto()      
...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.EAUTO:          "eauto",
    MODEL_ARCH.AUTOEE:         "autoee",
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    # we autoee & eagle add
    MODEL_TENSOR.PRED_UP:                   "blk.{bid}.pred.up",
    MODEL_TENSOR.PRED_DOWN:                 "blk.{bid}.pred.down",
    
    # EAGLE
    MODEL_TENSOR.EAGLE_TOKEN_EMBD:           "eagle.token_embd",
    MODEL_TENSOR.EAGLE_ATTN_Q:               "eagle.attn_q",
    MODEL_TENSOR.EAGLE_ATTN_K:               "eagle.attn_k",
    MODEL_TENSOR.EAGLE_ATTN_V:               "eagle.attn_v",   
    MODEL_TENSOR.EAGLE_ATTN_OUT:             "eagle.attn_output",      
    MODEL_TENSOR.EAGLE_FFN_NORM:             "eagle.ffn_norm",    
    MODEL_TENSOR.EAGLE_FFN_GATE:             "eagle.ffn_gate",         
    MODEL_TENSOR.EAGLE_FFN_DOWN:             "eagle.ffn_down",          
    MODEL_TENSOR.EAGLE_FFN_UP:               "eagle.ffn_up",          
    MODEL_TENSOR.EAGLE_FC:                   "eagle.fc",       
...
MODEL_TENSORS: dict[MODEL_ARCH, list[MODEL_TENSOR]] = {
    ...
    MODEL_ARCH.EAUTO: [
        ...
        # EAGLE
        MODEL_TENSOR.EAGLE_TOKEN_EMBD,
        MODEL_TENSOR.EAGLE_ATTN_Q,
        MODEL_TENSOR.EAGLE_ATTN_K,
        MODEL_TENSOR.EAGLE_ATTN_V,
        MODEL_TENSOR.EAGLE_ATTN_OUT,
        MODEL_TENSOR.EAGLE_FFN_NORM,
        MODEL_TENSOR.EAGLE_FFN_GATE,
        MODEL_TENSOR.EAGLE_FFN_DOWN,
        MODEL_TENSOR.EAGLE_FFN_UP,
        MODEL_TENSOR.EAGLE_FC,
    ],
    MODEL_ARCH.AUTOEE: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
