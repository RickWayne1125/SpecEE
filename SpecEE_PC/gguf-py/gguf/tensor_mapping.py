...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.EAGLE_ATTN_Q:(
            "layers.0.self_attn.q_proj",                             # eagle
        ),
        MODEL_TENSOR.EAGLE_ATTN_K:(
            "layers.0.self_attn.k_proj",                             # eagle
        ),
        MODEL_TENSOR.EAGLE_ATTN_V:(
            "layers.0.self_attn.v_proj",                             # eagle
        ),
        MODEL_TENSOR.EAGLE_ATTN_OUT:(
            "layers.0.self_attn.o_proj",                             # eagle
        ),
        ...
        MODEL_TENSOR.EAGLE_FFN_NORM:(
            "layers.0.post_attention_layernorm",                         # eagle
        ),
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        # predictor autoee & eagle
        MODEL_TENSOR.PRED_UP: ( # predictor up 
            'model.layers.{bid}.pred.up',
        ),
        MODEL_TENSOR.PRED_DOWN: ( 
            'model.layers.{bid}.pred.down', # predictor down
            # 'fc' # eagle down
        ),
